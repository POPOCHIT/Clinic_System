...
<body>
	...
	<!-- ROW of Content -->
	<div class="row1">
	<a class="navbar-brand" href="#" >Specialist Clinic</a>
		<div class="column1">
	...
	<div class="menu_bar">
		...
		<div class="menu_link">
			...
			<a href="file/appointment.php">Appointment </a> |
	...
	<div class="heartbeat">
		<a href="doctors.php">
			<img src="img/finddoctor_Fotor.png" class="finddoctorimg">
			<!-- <p>Find a Doctor</p> -->
		</a>
	</div>
	...
	<div class="row">
		<div class="col-lg-4 d-flex flex-column text-center justify-content-center align-items-center">
			...
			<p>M.B.,B.S., MRCP (UK) <br> M.Med.Sc (Internal Medicine), <br>
		...
		<div class="col-lg-4 d-flex flex-column text-center justify-content-center align-items-center">
		<img src="img/pyaepyae_Fotor.jpg" alt="drprofile" class="rounded-circle" width="150" height="150" >
			<h2>Dr. Nandar</h2>
			<p>
			M.B.,B.S (Ygn), M.Med.Sc (Int. Med), <br> MRCP (UK), Dr.Med.Sc (Cardiology) <br>
			University of medicine Magway <br>
		...
		<img src="img/myinzu.jpg" alt="drprofile" class="rounded-circle" width="150" height="150" >
			...
			<p>
			M.B.,B.S, M.MedSc [Pead], <br> MRCPCH (UK) <br>
			University of medicine (2) Yangon <br>
		...
		<img src="img/zinlintun_Fotor.jpg" alt="drprofile" class="rounded-circle" width="150" height="150" >
			...
			<p>
			M.B.,B.S, M.Med.Sc (Int.Med), <br> Dr.Med.Sc ( Neurology) <br>
			University of medicine (1) Yangon <br>
